...
Let's look a little more closely at the Kalman gain. It depends solely on three factors: the initial uncertainty (*v*<sub>0, *t*</sub>), the error variance (*σ*<sub>*ϵ*</sub><sup>2</sup>), and the innovation variance (*σ*<sub>*ξ*</sub><sup>2</sup>). Let's plot the value of the Kalman gain over time for different choices of these parameters:

![](fit_kf_rl_1_files/figure-markdown_github/unnamed-chunk-3-1.png)
